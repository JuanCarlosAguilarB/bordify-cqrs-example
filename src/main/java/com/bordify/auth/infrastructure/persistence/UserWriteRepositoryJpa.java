...
public interface UserWriteRepositoryJpa extends JpaRepository<UserWriteModelEntity, UUID> {
     ...
     */
    public Optional<UserWriteModelEntity> findByUserName(String userName);
     ...
     */
    public Optional<UserWriteModelEntity> findByEmail(String email);
