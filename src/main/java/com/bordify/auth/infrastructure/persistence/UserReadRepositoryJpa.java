...
//public interface UserReadRepositoryJpa extends JpaRepository<UserReadModelEntity, UUID> {
public interface UserReadRepositoryJpa extends CrudRepository<UserReadModelEntity, UUID> {
